        ...
        <div className="md:col-span-1 flex flex-col gap-6">
          ...
          <div className="w-full flex flex-col">
            <div className="flex items-center gap-2 px-0 py-2.5 border-b border-zinc-200/40 dark:border-zinc-800/40 bg-transparent">
              ...
              <span className="ml-3 flex-1 text-[10px] font-mono text-[var(--color-text-muted)] dark:text-[var(--color-text-main)]0 truncate">
        ...
        <div className="md:col-span-1 sticky top-24 h-max flex flex-col gap-4">
            ...
            <button
              ...
              className={`absolute top-3 right-3 p-2 rounded-lg border transition-all duration-200 cursor-pointer ${
                copied
                  ...
                  : 'bg-zinc-100 dark:bg-zinc-800/80 border-zinc-200 dark:border-zinc-700 text-[var(--color-text-main)]0 hover:text-zinc-800 dark:hover:text-zinc-200 hover:border-zinc-350 dark:hover:border-zinc-600 hover:bg-zinc-200 dark:hover:bg-zinc-700/80'
              }`}
              title="Copy snippet"
          ...
          <div className="flex flex-col gap-3 mt-2">
            <div className="flex items-start gap-2">
              ...
              <span className="text-xs text-[var(--color-text-main)]0 dark:text-[var(--color-text-muted)] leading-relaxed">
