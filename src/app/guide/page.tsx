      ...
      <div className="max-w-4xl mx-auto space-y-20">
        ...
        <article className="space-y-6">
          ...
          <p className="leading-relaxed text-slate-300">
            ...
            dotted-decimal notation you see every day: <code className="text-cyan-300 bg-slate-800 px-1.5 py-0.5 rounded text-sm">192.168.1.75</code>.
          </p>
          ...
          <p className="leading-relaxed text-slate-300">
            ...
            <strong className="text-slate-100">bitwise AND operation</strong> between the
          ...
          <p className="leading-relaxed text-slate-300">
            ...
            <strong className="text-slate-100">network address</strong> — the canonical
          ...
          <div className="bg-slate-900 border border-slate-800 rounded-xl p-6 font-mono text-sm space-y-2">
            <p className="text-slate-400 text-xs uppercase tracking-widest mb-4">Bitwise AND — Worked Example</p>
            <p><span className="text-slate-500">IP Address:   </span><span className="text-amber-300">11000000.10101000.00000001.01001011</span><span className="text-slate-500 ml-4">→ 192.168.1.75</span></p>
            <p><span className="text-slate-500">Subnet Mask:  </span><span className="text-cyan-300">11111111.11111111.11111111.00000000</span><span className="text-slate-500 ml-4">→ 255.255.255.0</span></p>
            <div className="border-t border-slate-700 my-2" />
            <p><span className="text-slate-500">Network Addr: </span><span className="text-emerald-300">11000000.10101000.00000001.00000000</span><span className="text-slate-500 ml-4">→ 192.168.1.0</span></p>
          </div>

          <p className="leading-relaxed text-slate-300">
            Consider the example above. The IP address <code className="text-amber-300 bg-slate-800 px-1.5 py-0.5 rounded text-sm">192.168.1.75</code> is
            AND-ed with the subnet mask <code className="text-cyan-300 bg-slate-800 px-1.5 py-0.5 rounded text-sm">255.255.255.0</code>. In binary,
            ...
            <code className="text-emerald-300 bg-slate-800 px-1.5 py-0.5 rounded text-sm">192.168.1.0</code>, is the network address, telling the
            router that this packet belongs to the <code className="text-slate-200 bg-slate-800 px-1.5 py-0.5 rounded text-sm">192.168.1.0/24</code>{' '}
        ...
        <article className="space-y-6">
          ...
          <p className="leading-relaxed text-slate-300">
            ...
            Class B networks, identified by leading bits <code className="text-slate-200 bg-slate-800 px-1.5 py-0.5 rounded text-sm">10</code>, split the
            ...
            leading bits <code className="text-slate-200 bg-slate-800 px-1.5 py-0.5 rounded text-sm">110</code>, allocated only 8 bits for hosts,
          ...
          <p className="leading-relaxed text-slate-300">
            ...
            <strong className="text-slate-100">RFC 1519 in 1993</strong>, was Classless
            Inter-Domain Routing (CIDR). CIDR abolished the concept of fixed network
            classes entirely and replaced it with a flexible{' '}
            <strong className="text-slate-100">prefix-length notation</strong>. Under
          ...
          <div className="grid sm:grid-cols-3 gap-4 my-6">
            {[
              ...
              <div key={row.prefix} className="bg-slate-900 border border-slate-800 rounded-xl p-4 text-center">
                <p className="text-2xl font-bold font-mono text-cyan-400">{row.prefix}</p>
                <p className="text-xs text-slate-500 font-mono mt-1">{row.mask}</p>
                <p className="text-sm font-semibold text-emerald-400 mt-2">{row.hosts} hosts</p>
                <p className="text-xs text-slate-600 mt-1">{row.label}</p>
              </div>
            ))}
          </div>
          ...
          <p className="leading-relaxed text-slate-300">
            ...
            <code className="text-cyan-300 bg-slate-800 px-1.5 py-0.5 rounded text-sm">/26</code> block — yielding exactly 62 usable host
            addresses — rather than wasting a full Class C block of 254. Crucially,
            CIDR also introduced{' '}
            <strong className="text-slate-100">route summarisation</strong> (also called
            ...
            <code className="text-cyan-300 bg-slate-800 px-1.5 py-0.5 rounded text-sm">203.0.113.0/24</code> can summarise 256 individual host
        ...
        <article className="space-y-6">
          ...
          <p className="leading-relaxed text-slate-300">
            ...
            <code className="text-cyan-300 bg-slate-800 px-1.5 py-0.5 rounded text-sm">/24</code> mask applied to every segment, each
          ...
          <p className="leading-relaxed text-slate-300">
            <strong className="text-slate-100">Variable Length Subnet Masking (VLSM)</strong>,
          ...
          <ol className="list-decimal list-inside space-y-3 pl-2 text-slate-300">
            <li className="leading-relaxed">
              <strong className="text-slate-100">Inventory and Sort:</strong> Enumerate
            ...
            <li className="leading-relaxed">
              <strong className="text-slate-100">Select the Minimal Prefix:</strong> For
            ...
            <li className="leading-relaxed">
              <strong className="text-slate-100">Allocate on a Natural Boundary:</strong>{' '}
            ...
            <li className="leading-relaxed">
              <strong className="text-slate-100">Advance the Pointer:</strong> Move the
            ...
            <li className="leading-relaxed">
              <strong className="text-slate-100">Recurse for WAN Links:</strong> Point-to-point
              links require exactly 2 host addresses. Assign{' '}
              <code className="text-cyan-300 bg-slate-800 px-1.5 py-0.5 rounded text-sm">/30</code> blocks (4 total addresses, 2 usable) to
              every WAN link. Loopback interfaces and host routes are assigned{' '}
              <code className="text-cyan-300 bg-slate-800 px-1.5 py-0.5 rounded text-sm">/32</code> blocks.
            </li>
          </ol>
          ...
          <p className="leading-relaxed text-slate-300">
            ...
            <code className="text-cyan-300 bg-slate-800 px-1.5 py-0.5 rounded text-sm">172.16.0.0/12</code> block, which provides only
