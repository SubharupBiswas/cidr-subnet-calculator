...
export default function SubnetGuide() {
  ...
  const heading = 'text-base font-bold text-zinc-100 flex items-center gap-2.5';
  const strong  = 'font-semibold text-zinc-200';
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-10">
        <div className="lg:col-span-7 flex flex-col gap-8">
          <SectionCard>
            ...
            <div className="bg-zinc-950/80 border border-zinc-800 rounded-lg p-4 font-mono text-sm flex flex-col gap-2">
          ...
          <SectionCard>
            ...
            <div className="bg-purple-500/5 border border-purple-500/20 rounded-xl p-5 flex flex-col gap-4">
          ...
          <SectionCard>
            ...
            <div className="flex flex-col gap-3">
              <div className="flex items-start gap-3 bg-zinc-800/40 border border-zinc-700/40 rounded-lg p-4">
        ...
        <div className="lg:col-span-5">
          <div className="border border-zinc-800 rounded-xl bg-zinc-950/50 overflow-hidden flex flex-col sticky top-8">
            ...
            <div className="overflow-y-auto custom-scrollbar" style={{ maxHeight: '680px' }}>
              <table className="w-full text-left border-collapse font-mono text-xs">
                <thead className="sticky top-0 bg-zinc-950/90 backdrop-blur-sm z-10 border-b border-zinc-800">
                ...
                <tbody className="divide-y divide-zinc-800/50">
                  {matrixRows.map((row) => (
                    <tr key={row.prefix} className="hover:bg-zinc-800/30 transition-colors">
                      <td className="py-2.5 px-4 text-center font-bold text-cyan-400">
                        /{row.prefix}
                      </td>
