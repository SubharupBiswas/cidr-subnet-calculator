...
export function Footer() {
  return (
    <footer className="border-t border-zinc-200/80 dark:border-white/[0.04] py-8 mt-16 bg-zinc-50/50 dark:bg-zinc-950/40 text-zinc-600 dark:text-zinc-400 text-xs transition-colors duration-300">
      <div className="max-w-7xl mx-auto px-4 flex flex-col md:flex-row items-center justify-between gap-6">

        {/* Copyright Attribution */}
        <div className="flex items-center gap-2 text-zinc-700 dark:text-zinc-400">
          <Network className="w-4 h-4 text-zinc-500 dark:text-zinc-500" />
